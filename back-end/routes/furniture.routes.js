...
router.post("/add", async (req, res) => {
  try {
    const { name, category_id, materials_used, img, description, quantity } =
      req.body;
    const result = await pool.query(
      "INSERT INTO furnitures (name, category_id, materials_used, img, description, quantity) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *",
      [name, category_id, materials_used, img, description, quantity]
    );
